...
public function savemovies(Request $request){
    ...
    return redirect('/pencucian')->with('alert', 'Data Berhasil di simpan');
}
    ...
    public function deletemovies($id)
    {
        ...
        return redirect("/pencucian")->with('alert','Data berhasil di Hapus');
    }
    ...
    public function updateuser(Request $request)
    {
        ...
        {
            return redirect("/user")->with("password gagal di ubah");
        }
    }
}
